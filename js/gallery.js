document.addEventListener('DOMContentLoaded', async function () {
	try {
		// Get the API base URL from the window API object
      ...
      `;
		...
		const galleryContainer = document.querySelector('.row.gallery-container');
		if (galleryContainer) {
			galleryContainer.innerHTML = `<div class="col-12 text-center"><p>Error loading gallery. Please try again later.</p></div>`;
		}
	}
});
